...
pub fn solve(input: &str) -> usize {
    ...
    eprint_grid(&grid);
    get_amount_rooms_with_distance_greater_than_1000(&grid)
}
...
fn get_amount_rooms_with_distance_greater_than_1000(grid: &Grid) -> usize {
    ...
    let mut amount_rooms_with_distance_greater_than_1000 = 0;
    ...
    loop {
        ...
        if distance >= 1000 {
            amount_rooms_with_distance_greater_than_1000 += 1;
        }

        seem.insert(current_position, distance);
    }

    amount_rooms_with_distance_greater_than_1000
}
